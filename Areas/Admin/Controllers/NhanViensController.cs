...
namespace Shopee_Food.Areas.Admin.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNV,MaTK,ChucVu,DanhGia")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNV,MaTK,ChucVu,DanhGia")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
